...
-- Disable continuous comments on new line
...

  {
    ...
    config = function()
      ...
      dap.configurations.rust = {
        ...
        {
          name = 'Launch - Debug - Same Name As Directory',
          type = 'lldb',
          request = 'launch',
          cwd = '${workspaceFolder}',
          stopOnEntry = false,
          ...
          program = function()
            ...
            local project_name = vim.fs.basename(current_dir)

            return current_dir .. '/target/debug/' .. project_name
          end,
          initCommands = initCommands,
        },
      }
